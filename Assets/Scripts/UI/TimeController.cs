...
public class TimeController : MonoBehaviour
{
    ...
    [SerializeField]
    public float startHour; //hora em que o jogo começa
    ...
    public DateTime currentTime; //mantém gravada a hora atual

    private TimeSpan sunriseTime; //usado para cálculo

    private TimeSpan sunsetTime; //usado para cálculo

    public static TimeController instance; // Referência estática para a instância única
